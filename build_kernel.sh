...
# very very slightly modified by friedrich420 for his Ael S6E Plus kernel     #
#                                                         		      #
###############################################################################
...
# make modules
make -j5 modules ARCH=arm64  || exit 1;
...
GETVER=`grep 'S6E_Plus_Ael_MM_*v' ${KERNELDIR}/.config | sed 's/.*".//g' | sed 's/-S.*//g'`
